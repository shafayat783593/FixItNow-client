    ...
    <div className="relative w-full">
      ...
      <div className="flex flex-wrap items-center gap-2 lg:flex-nowrap">
        ...
        <div className="relative min-w-[130px] flex-1">
          <Grid size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
          <select
            value={currentCategory}
            onChange={(e) => updateParam("category", e.target.value || null)}
            className="w-full appearance-none rounded-xl bg-muted py-2.5 pl-8 pr-7 text-xs font-semibold text-foreground transition-all hover:bg-secondary focus:bg-card focus:outline-none focus:ring-2 focus:ring-accent/30"
          >
        ...
        <div className="relative min-w-[130px] flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl bg-muted py-2.5 pl-8 pr-3 text-xs font-medium text-foreground placeholder:text-muted-foreground transition-all hover:bg-secondary focus:bg-card focus:outline-none focus:ring-2 focus:ring-accent/30"
          />
        </div>

        {/* 3. Price Range Inputs */}
        <div className="flex items-center gap-1 min-w-[140px] flex-1 bg-muted rounded-xl px-2.5 py-1 transition-all hover:bg-secondary">
          ...
          <input
            ...
            className="w-full bg-transparent py-1 text-xs font-medium text-foreground placeholder:text-muted-foreground focus:outline-none"
          />
        ...
        <div className="relative min-w-[110px] flex-1">
          <Star size={13} className="absolute left-3 top-1/2 -translate-y-1/2 text-accent fill-accent" />
          <select
            value={currentRating}
            onChange={(e) => updateParam("rating", e.target.value || null)}
            className="w-full appearance-none rounded-xl bg-muted py-2.5 pl-7 pr-6 text-xs font-semibold text-foreground transition-all hover:bg-secondary focus:bg-card focus:outline-none focus:ring-2 focus:ring-accent/30"
          >
