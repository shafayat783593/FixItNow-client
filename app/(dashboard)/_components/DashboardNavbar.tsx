            ...
            <div className="flex justify-between items-center gap-4">
                <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="relative flex-1 max-w-md hidden md:block">
                        <Search size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-body" />
                        <input
                            type="text"
                            value={searchQuery}
                    ...
                    <div className="relative notification-menu">
                        ...
                        {isNotificationsOpen && (
                            <div className="absolute right-0 mt-3 w-72 bg-card rounded-2xl shadow-2xl border border-accent-10 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2">
                                ...
                                <div className="p-4 text-center text-xs text-body italic">No new notifications</div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="relative user-menu ml-2">
                        ...
                        >
                            ...
                            <div className="hidden lg:block text-left">
                                <p className="text-sm font-black text-heading leading-none">{user?.name || 'User'}</p>
                                <p className="text-[10px] text-body mt-1 font-bold uppercase tracking-tighter">{user?.role || 'Member'}</p>
                            </div>
                        </button>
